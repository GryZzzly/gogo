...
label sacrament_complete:
    call expression game.dialog_select("sacrament_complete_dialogue") from _call_expression_1425
    $ game.timer.tick()
    $ player.go_to(L_map)
    $ game.main()
...
label sacrament_complete_dialogue:
    ...
    show ang 5f
    show player 10f
    player_name "I'd better get back home."
    hide player
    hide helen
    hide ang
    with dissolve
...
label angelicas_room_dialogue_mia_find_sinners:
    ...
    player_name "Okay. I'll see what I can do..."
    hide player
    hide ang
    with dissolve
    return
...
label helen_sacrement_training_part2:
    call expression game.dialog_select("helen_sacrement_training_part2_pre") from _call_expression_1426
    $ renpy.end_replay()
    $ persistent.cookie_jar["Angelica"]["unlocked"] = True
    $ persistent.cookie_jar["Angelica"]["gallery"]["01_unlocked"] = True
    call expression game.dialog_select("helen_sacrement_training_part2_after") from _call_expression_1427
    $ game.timer.tick()
...
label helen_sacrement_training_part2_pre:
    ...
    show ang 15
    with dissolve
    ang "As I work your body over with this whip you will learn to remember what awaits you in hell if you don't submit to my... {b}God's{/b} will."
    helen "What?"
    show helen whip 1 at Position (xpos=161)
    show ang 18 at Position (xoffset=312)
    hide player
...
label angelicas_room_dialogue_default_pre:
    ...
    show player 10f at right
    show ang 1f at left
    ang "What are you doing here?!" with hpunch
    show player 3f
    player_name "Hmmmm... Sightseeing?"
    ang "Leave at once!!! You have no business here." with hpunch
    hide player
    hide ang
    hide helen
    with dissolve
