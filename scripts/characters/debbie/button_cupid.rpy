label mom_cupid_outing:
    ...
    if M_mom.is_state(S_mom_choose_gift):
        call expression game.dialog_select("mom_cupid_outing_choose_gift") from _call_expression_930

    elif M_mom.is_state(S_mom_show_necklace):
        $ player.remove_item("pearl_necklace")
        call expression game.dialog_select("mom_cupid_outing_show_necklace") from _call_expression_931
