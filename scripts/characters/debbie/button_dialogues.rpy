    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            if animcounter in [1,3]:
                call expression game.dialog_select("debbie_kitchen_hscene_dialog") from _call_expression_807
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            if animcounter in [1,3]:
                call expression game.dialog_select("debbie_kitchen_hscene_dialog") from _call_expression_808
        $ animcounter += 1
...
label mom_kitchen_fuck_cum:
    call expression game.dialog_select("mom_kitchen_fuck_cum_dialogue") from _call_expression_809
    $ renpy.end_replay()
...
label debbie_dialogue_sex_in_debbies_room_basement:
    ...
    label sex_mom_bed_intro_1:
        ...
        if not store._in_replay == None:
            call expression game.dialog_select("debbie_dialogue_sex_in_debbies_room_after") from _call_expression_810
...
label debbie_dialogue_sex_in_debbies_room_kitchen:
    ...
    label sex_mom_bed_intro_2:
        ...
        show debbie 103
        if not store._in_replay == None:
            call expression game.dialog_select("debbie_dialogue_sex_in_debbies_room_after") from _call_expression_811
            jump expression game.dialog_select("mom_sex")
    return
