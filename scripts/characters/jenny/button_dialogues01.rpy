...
label jenny_dialogue_trade_panties:
    menu:
        "Not yet." if (not sister.known(sis_panty02) or not sister.known(sis_panty03) or not sister.known(sis_panty04)) or (sister.completed(sis_panty02) or sister.completed(sis_panty03) or sister.completed(sis_panty04)):
            call expression game.dialog_select("jenny_dialogue_trade_panties_not_yet") from _call_expression_1922
        ...
        "Yeah, more panties." if sister.started(sis_panty02) or sister.started(sis_panty03) or sister.started(sis_panty04):
            if sis_quest_first:
                if sister.started(sis_panty04):
                    call expression game.dialog_select("jenny_dialogue_trade_panties_more_panties_first_panty04") from _call_expression_1923

                elif sister.started(sis_panty03):
                    call expression game.dialog_select("jenny_dialogue_trade_panties_more_panties_first_panty03") from _call_expression_1924

                elif sister.started(sis_panty02):
                    call expression game.dialog_select("jenny_dialogue_trade_panties_more_panties_first_panty02") from _call_expression_1925
                ...
                label sybian_replay:
                    call expression game.dialog_select("jenny_dialogue_trade_panties_more_panties_repeat") from _call_expression_1926
                    if not store._in_replay == None:
                        call expression game.dialog_select("sybian_replay_continue") from _call_expression_1927
            menu:
                "Here's the toy." if player.has_item("sybian") and sister.started(sis_panty04):
                    label sybian_replay_continue:
                        call expression game.dialog_select("jenny_dialogue_trade_panties_have_toy_sybian") from _call_expression_1928
                    $ sybian_stage = 0
                ...
                "Here's the toy." if player.has_item("ultravibrato") and sister.started(sis_panty03):
                    call expression game.dialog_select("jenny_dialogue_trade_panties_have_toy_ultravibrato") from _call_expression_1929
                ...
                "Here's the toy." if player.has_item("electroclit") and sister.started(sis_panty02):
                    call expression game.dialog_select("jenny_dialogue_trade_panties_have_toy_electroclit") from _call_expression_1930
                    $ player.get_item("panties")
                ...
                "I don't have it." if sister.started(sis_panty02) and not player.has_item("electroclit") or sister.started(sis_panty03) and not player.has_item("ultravibrato") or sister.started(sis_panty04) and not player.has_item("sybian"):
                    call expression game.dialog_select("jenny_dialogue_trade_panties_do_not_have_toy") from _call_expression_1931
                "I don't need it.":

                    call expression game.dialog_select("jenny_dialogue_trade_panties_do_not_need_panties") from _call_expression_1932
    return
