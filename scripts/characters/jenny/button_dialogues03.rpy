    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            if animcounter in [1,3]:
                call expression game.dialog_select("jenny_cheerleader_hscene_dialog") from _call_expression_2208
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            if animcounter in [1,3]:
                call expression game.dialog_select("jenny_cheerleader_hscene_dialog") from _call_expression_2209
        $ animcounter += 1
...
label sis_cheerleader_fuck_cum_outside:
    if anim_toggle:
        call expression game.dialog_select("sis_cheerleader_fuck_cum_outside_animation") from _call_expression_2210
    else:
        call expression game.dialog_select("sis_cheerleader_fuck_cum_outside_manual") from _call_expression_2211
    $ xray = False
    call expression game.dialog_select("sis_cheerleader_fuck_cum_outside_after") from _call_expression_2212
    if store._in_replay == None and sister.completed(sis_final2):
        call expression game.dialog_select("sis_cheerleader_fuck_after_repeat") from _call_expression_2213
    else:
        call expression game.dialog_select("sis_cheerleader_fuck_after_initial") from _call_expression_2214
    $ renpy.end_replay()
...
label sis_cheerleader_break_free_fail:
    if anim_toggle:
        call expression game.dialog_select("sis_cheerleader_break_free_fail_animation") from _call_expression_2215
    else:
        call expression game.dialog_select("sis_cheerleader_break_free_fail_manual") from _call_expression_2216
    call screen sis_cheerleader_sex_options
...
label sis_cheerleader_break_free_pass:
    ...
    if anim_toggle:
        call expression game.dialog_select("sis_cheerleader_break_free_pass_animation") from _call_expression_2217
    else:
        call expression game.dialog_select("sis_cheerleader_break_free_pass_manual") from _call_expression_2218
    call expression game.dialog_select("sis_cheerleader_break_free_pass_after") from _call_expression_2219
