...
label sis_cheerleader_fuck_cum_inside_unhappy:
    if anim_toggle:
        call expression game.dialog_select("sis_cheerleader_fuck_cum_inside_unhappy_animation") from _call_expression_1619
    else:
        call expression game.dialog_select("sis_cheerleader_fuck_cum_inside_unhappy_manual") from _call_expression_1620
    call expression game.dialog_select("sis_cheerleader_fuck_cum_inside_unhappy_after") from _call_expression_1621
    $ xray = False
    call expression game.dialog_select("sis_cheerleader_fuck_cum_inside_unhappy_after_no_xray") from _call_expression_1622
    call expression game.dialog_select("sis_cheerleader_fuck_after") from _call_expression_1623
    $ renpy.end_replay()
...
label sis_cheerleader_fuck_cum_inside_happy:
    if anim_toggle:
        call expression game.dialog_select("sis_cheerleader_fuck_cum_inside_happy_animation") from _call_expression_1624
    else:
        call expression game.dialog_select("sis_cheerleader_fuck_cum_inside_happy_manual") from _call_expression_1625
    call expression game.dialog_select("sis_cheerleader_fuck_cum_inside_happy_after") from _call_expression_1626
    $ xray = False
    call expression game.dialog_select("sis_cheerleader_fuck_cum_inside_happy_after_no_xray") from _call_expression_1627
    call expression game.dialog_select("sis_cheerleader_fuck_after_repeat") from _call_expression_1628
    jump expression game.dialog_select("hallway_dialogue")
