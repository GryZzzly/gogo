...
label jenny_dialogue_watch_neighbours_menu:
    menu:
        "Keep going.":
            call expression game.dialog_select("jenny_dialogue_watch_neighbours_menu_keep_going") from _call_expression_287
            call expression game.dialog_select("jenny_dialogue_watch_neighbours_menu") from _call_expression_288
        "Make her cum.":

            call expression game.dialog_select("jenny_dialogue_watch_neighbours_menu_make_her_cum") from _call_expression_289
            $ renpy.end_replay()
