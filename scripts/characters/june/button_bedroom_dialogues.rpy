...
label june_bedroom_dialogue_normal_sex_cum_inside:
    call expression game.dialog_select("june_bedroom_dialogue_normal_sex_cum_inside_dialogue") from _call_expression_1148
    call expression game.dialog_select("june_bedroom_dialogue_aftercum_inside") from _call_expression_1149
    $ game.main()
...
label june_bedroom_dialogue_normal_sex_cum_outside:
    call expression game.dialog_select("june_bedroom_dialogue_normal_sex_cum_outside_dialogue") from _call_expression_1150
    call expression game.dialog_select("june_bedroom_dialogue_aftercum_outside") from _call_expression_1151
    $ game.main()
...
label june_bedroom_dialogue_cosplay_sex_cum_inside:
    call expression game.dialog_select("june_bedroom_dialogue_cosplay_sex_cum_inside_dialogue") from _call_expression_1152
    if not store._in_replay == None or June.over(june_cosplay):
        call expression game.dialog_select("june_bedroom_dialogue_aftercum_inside") from _call_expression_1153
    else:
        call expression game.dialog_select("june_bedroom_dialogue_aftercum_initial") from _call_expression_1154
    $ renpy.end_replay()
...
label june_bedroom_dialogue_cosplay_sex_cum_outside:
    call expression game.dialog_select("june_bedroom_dialogue_cosplay_sex_cum_outside_dialogue") from _call_expression_1155
    if not store._in_replay == None or June.over(june_cosplay):
        call expression game.dialog_select("june_bedroom_dialogue_aftercum_outside") from _call_expression_1156
    $ renpy.end_replay()
    $ persistent.cookie_jar["June"]["unlocked"] = True
    $ persistent.cookie_jar["June"]["gallery"]["01_unlocked"] = True
    $ June.complete_events(june_cosplay)
