...
label button_okita_generic_after_q3:
    call expression game.dialog_select("button_okita_generic_after_q3_intro") from _call_expression_575
    menu:
        "New Invention." if M_okita.is_state(S_okita_is_hypersexual):
            call expression game.dialog_select("button_okita_generic_after_q3_new_invention") from _call_expression_576
        "Nothing.":

            call expression game.dialog_select("button_okita_generic_after_q3_leave") from _call_expression_577
    return
