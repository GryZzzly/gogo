...
label terry_dialogue_buy_fish_buy:
    if not player.has_money(100):
        call expression game.dialog_select("terry_dialogue_buy_fish_buy_no_money") from _call_expression_1468
        call expression game.dialog_select("terry_dialogue_buy_fish_nevermind") from _call_expression_1469

    call expression game.dialog_select("terry_dialogue_buy_fish_buy_pre") from _call_expression_1470
    ...
    call expression game.dialog_select("terry_dialogue_buy_fish_buy_after") from _call_expression_1471
...
label terry_dialogue_sell_fish_sell:
    call expression game.dialog_select("terry_dialogue_sell_fish_sell_pre") from _call_expression_1472
    ...
    call expression game.dialog_select("terry_dialogue_buy_fish_buy_after") from _call_expression_1473
    $ player.get_money(80)
    return
...
label terry_dialogue_buy_drink:
    if not player.has_money(5):
        call expression game.dialog_select("terry_dialogue_buy_drink_no_money") from _call_expression_1474
    else:

        call expression game.dialog_select("terry_dialogue_buy_drink_buy") from _call_expression_1475
