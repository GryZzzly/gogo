...
label INIT_FSM:
    call INIT_FSM_TRIGGERS from _call_INIT_FSM_TRIGGERS
    call INIT_FSM_MACHINES from _call_INIT_FSM_MACHINES
    $ renpy.not_infinite_loop(10)
    python:
...
label INIT_GLOBAL:
    call INIT_LOCATIONS from _call_INIT_LOCATIONS_1
    call INIT_FSM from _call_INIT_FSM_1
    call INIT_INVENTORY_ITEMS from _call_INIT_INVENTORY_ITEMS_1
    call INIT_JSONS from _call_INIT_JSONS
    python:
