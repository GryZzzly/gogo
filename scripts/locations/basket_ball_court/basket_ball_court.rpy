label basket_court_dialogue:
    ...
    if M_roxxy.get("dexter argument got information") and M_roxxy.is_state(S_roxxy_dexter_argument):
        call expression game.dialog_select("basketball_court_roxxy_dexter_argument") from _call_expression_702
        ...
        call expression game.dialog_select("basketball_court_roxxy_dexter_alcohol_fight") from _call_expression_703
        ...
        call expression game.dialog_select("basketball_court_bissette_get_books") from _call_expression_704
        ...
        call expression game.dialog_select("basketball_court_roxxy_basketball_challenge") from _call_expression_705
        jump basketball_minigame_prepare

    elif M_dexter.is_state(S_dex_start) and player.location.is_here(M_dexter):
        call expression game.dialog_select("basketball_court_dexter_start") from _call_expression_706
