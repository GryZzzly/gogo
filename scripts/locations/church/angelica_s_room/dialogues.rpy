...
label priest_outfit:
    call expression game.dialog_select("priest_outfit_dialogue") from _call_expression_1487
...
label helen_final_sacrament:
    ...
    label helen_final_mc:
        call expression game.dialog_select("helen_final_sacrament_pre") from _call_expression_1488
    ...
    menu mia_helen_route_spilt:
        "Fuck {b}Helen{/b}.":
            label helen_mc_replay:
                call expression game.dialog_select("helen_final_sacrament_fuck_helen_pre") from _call_expression_1489

            label helen_mc_churchsex:
                call expression game.dialog_select("helen_final_sacrament_fuck_helen_after") from _call_expression_1490
        ...
        "Watch {b}Sister Angelica{/b}.":
            ...
            label helen_ang_replay:
                call expression game.dialog_select("helen_final_sacrament_watch_angelica") from _call_expression_1491
...
label helen_final_sacrament_fuck_helen_loop:
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            pause 2
            call expression game.dialog_select("helen_final_sacrament_hscene_dialog") from _call_expression_1492
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            call expression game.dialog_select("helen_final_sacrament_hscene_dialog") from _call_expression_1493
        $ animcounter += 1
...
label helen_final_sacrament_fuck_helen_cum:
    call expression game.dialog_select("helen_final_sacrament_fuck_helen_cum_pre") from _call_expression_1494
    if not M_helen.is_state(S_helen_start):
        jump expression game.dialog_select("sacrament_complete")

    call expression game.dialog_select("helen_final_sacrament_fuck_helen_cum_after") from _call_expression_1495
    $ renpy.end_replay()
...
label helen_final_sacrament_watch_angelica_loop:
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            pause 2
            call expression game.dialog_select("angelica_final_sacrament_hscene_dialog") from _call_expression_1496
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ poses_done.append(pose_list[pose_counter])
                $ pose_counter += 1
            call expression game.dialog_select("angelica_final_sacrament_hscene_dialog") from _call_expression_1497
        $ animcounter += 1
...
label helen_final_sacrament_watch_angelica_cum:
    call expression game.dialog_select("helen_final_sacrament_watch_angelica_cum_pre") from _call_expression_1498
    $ renpy.end_replay()
    $ persistent.cookie_jar["Angelica"]["unlocked"] = True
