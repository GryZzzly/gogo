...
label confessional_left:
    if M_mia.is_state(S_mia_return_priest_outfit):
        call expression game.dialog_select("confessional_left_mia_return_priest_outfit") from _call_expression_1371

    elif M_mia.is_state(S_mia_priest_act):
        call expression game.dialog_select("confessional_left_mia_priest_act") from _call_expression_1372
    else:

        call expression game.dialog_select("confessional_left_empty") from _call_expression_1373
    $ game.main()
...
label confessional_right:
    if M_mia.is_state(S_mia_return_priest_outfit):
        call expression game.dialog_select("confessional_right_mia_return_priest_outfit") from _call_expression_1374

    elif M_mia.is_state(S_mia_priest_act):
        call expression game.dialog_select("confessional_right_mia_priest_act_pre") from _call_expression_1375
        menu:
            "Pray?" if player.stats.chr() < 3:
                call expression game.dialog_select("confessional_right_mia_priest_act_pray") from _call_expression_1376

                $ M_mia.trigger(T_helen_convince_fail)

            "Change." if player.stats.chr() >= 3:
                call expression game.dialog_select("confessional_right_mia_priest_act_change") from _call_expression_1377
                $ M_mia.trigger(T_helen_convince_change)
                jump expression game.dialog_select("church_dialogue")
    else:

        call expression game.dialog_select("confessional_right_empty") from _call_expression_1378
    $ game.main()
