label dianes_garden_diane_drunken_splur_not_known:
    ...
    with dissolve
    dia "Yoo-hooo! Theeere's my handsome little man!"
    show player 5
    dia "How are you-*hic* doing today?"
    dia "You here to do a little plowing with that big shovel of yours?! Hehehe..."
    show diane 95
    show player 12
    ...
    show player 13
    show diane 166
    dia "That's what happens when you start drinking before you get dressed..."
    ...
    dia "Awww!"
    dia "You're so sweet..."
    dia "I am so enjoying our little chats!"
    show diane 167
    pause
    ...
    show player 5
    show diane 166
    dia "You must think I'm a- *hic* a big lush."
    show diane 165
    show player 21
...
label dianes_garden_diane_need_shovel:
    ...
    show player 1 at left
    dia "I'm guessing {b}[deb_name]{/b} told you I am looking for someone to help me this summer?"
    show diane 1 at right
    show player 2 at left
    player_name "Yeah and I could definitely use the money for tuition..."
    show diane 2 at right
...
label dianes_garden_diane_need_shovel_remove_waste_repeat:
    ...
    show player 203
    show diane 8
    dia "You think you can take care of that waste problem today?"
    show player 14
    player_name "It's no problem!"
...
label dianes_garden_diane_need_shovel_remove_waste:
    ...
    dia "It's so heavy though! I'm afraid it's too much for my poor back!"
...
label dianes_garden_diane_need_shovel_remove_waste_pass:
    ...
    show diane 6
    show player 11
    dia "I try to stay active all the time but I can't seem to get rid of all this fat."
    show diane 1
    show player 10
    ...
    show diane 12
    show player 13
    dia "Aww. You say now but if you saw me without clothes on; You'd be singing a different tune!"
    show diane 13
    show player 11
    player_name "..."
    show diane 5
    ...
    show diane 2
    show player 203
    dia "No problem, Stud! Thanks again for your help today."
...
label dianes_garden_diane_milk_delivery_week:
    ...
    show player 3
    dia "Yes!!"
    dia "I need a huge favor."
    show player 1
    player_name "Sure, {b}Diane{/b}! Anything you need!"
    show player 2
    dia "Great!"
    ...
    show diane 6
    dia "Heh, I know. Weird right?"
    dia "It's something I started doing not too long ago."
    show diane 108
    dia "Here's the {b}invoice{/b}."
    show diane 1
    player_name "So where is it? ... And where exactly do I deliver it?"
    show diane 22
    dia "Right! I'm sorry..."
    show diane 23
    ...
    show diane 14
    dia "Don't take too long, okay? I don't want them to think I'm selling spoiled milk!"
    return
...
label dianes_garden_diane_bug_infestation:
    ...
    show player 23
    show diane 22
    dia "They're all {b}ruined{/b}!"
    show player 10
    player_name "What do you mean? How?"
    show player 11
    show diane 106
    dia "It's some kind of awful infestation!"
    show player 22
    ...
    show player 14
    show diane 4
    player_name "Sure, {b}Diane{/b}, I can have a look."
    show player 13
    show diane 14
    ...
    show diane 10
    dia "You should go {b}ask someone who is working there{/b}. {b}Describe{/b} the bugs to them."
    show player 10
...
label dianes_garden_diane_sunbathing:
    ...
    player_name "Drinking again?"
    show player 13 at left
    dia "Hehe, Yeah... Just a little."
    show diane 19 at right
    dia "I think I lost my shirt again! Hehe."
    show diane 17 at right
    show player 21 at left
    player_name "...You lost it?"
    show diane 19 at right
    show player 13 at left
    dia "Margaritas have always had this effect on me... My clothes just seem to disappear!"
    show diane 17 at right
    show player 17 at left
...
label dianes_garden_diane_sunbathing_okay:
    ...
    pause
    show player 21 at left
    player_name "You want me to put sunscreen on you?"
    show diane 19 at right
    show player 13 at left
    dia "Well, of course!"
    show diane 18 at right
    dia "How else am I going to do my back?"
    dia "You don't want me to burn, do you?"
    show diane 17 at right
    show player 21 at left
    ...
    show diane 31
    player_name "Woah..."
    player_name "( I can't believe I'm touching {b}Diane{/b}'s naked back... )"
    show diane 30
    window hide
    pause
    show diane 31
    ...
    with dissolve
    player_name "I'm so sorry {b}Diane{/b}!!"
    ...
    player_name "Well... You're naked, {b}Diane{/b}!"
    show diane 46
...
label dianes_garden_diane_drunk_apology:
    ...
    player_name "Don't worry... I won't tell anyone."
    player_name "It wasn't a big deal anyway."
    hide player
    show diane 11 at left
    dia "Aww! Thanks hun! You're such a gentleman!"
...
label dianes_garden_diane_gardening_help:
    ...
    dia "Hey Handsome! You here to help old {b}Diane{/b} pick some vegetables?"
    show player 14 at left
    show diane 7 at right
    player_name "I don't think you look old at all, {b}Diane{/b}."
    show player 1 at left
    show diane 7 at right
...
label dianes_dialogue_drink:
    ...
    show diane 97
    show player 18
    dia "You sure know how to put a smile on my face, {b}[firstname]{/b}!"
    show player 11
    show diane 95
    dia "..."
    show player 13
...
label dianes_dialogue_drink_extra_shot:
    ...
    player_name "!!!"
    dia "As I suspected..."
    dia "I knew you would enjoy my breasts."
    show diane 80
    ...
    player_name "I'm sorry, {b}Diane{/b}!"
    dia "Don't be!"
    ...
    show diane 87
    dia "I've got myself a little crush on you."
    show diane 92
    dia "And you obviously have an attraction to me as well..."
    show diane 89
    dia "I don't see any reason we can't explore this a little further. So long as we keep it {b}between us{/b}, do you agree?"
    show diane 91
    show player 140
    player_name "What do you mean?"
    show player 139
    show diane 87
    dia "Well, you just let me know when you want some to have some fun with me."
    show diane 89
    dia "So long as you promise not to tell anyone about it!"
    show player 140
    show diane 88
    player_name "I guess... I could do that."
    show player 139
    show diane 90
    dia "Especially not {b}[deb_name]{/b}! She'd kill me!!!"
    show player 140
    show diane 91
    player_name "Don't worry. I won't tell her."
    show player 139
    show diane 90
    dia "That's my handsome man!"
    show diane 89
...
label dianes_dialogue_pre_fun_talk:
    ...
    show diane 7
    show player 10
    player_name "You've been very helpful to {b}[deb_name]{/b} and I during this whole thing with {b}my dad{/b}."
    player_name "I betcha {b}[deb_name]{/b} would love it if you came around more often..."
    show diane 22
    show player 13
    dia "I..."
    show diane 23
    dia "I'm just glad I could make things a little easier on you two."
    dia "Honestly, I've been enjoying the company as well."
    show diane 24
    show player 10
    player_name "Is everything okay?"
    show diane 3
    ...
    dia "I just..."
    show diane 6
    dia "Well, I guess, I've just gotten used to being on my own."
    dia "Since my husband and I divorced, I don't get out as much as I used to."
    show diane 14
    dia "Heh, makes me feel like I'm turning into a sour old woman!"
    show diane 1
    show player 108f
    player_name "Don't say that..."
    show diane 14
    show player 13
    dia "You probably don't know this, but {b}[deb_name]{/b} and I used to get pretty crazy back in our day!"
    show diane 8
    show player 11
    dia "We were fighting men off everywhere we went."
    show diane 3
    dia "... And the parties we used to throw! Phew!"
    show diane 4
    show player 21
    player_name "Really?"
    show diane 2
    ...
    dia "You bet!"
    show diane 10
    dia "We would go out on the town and dance all night together!"
    show diane 6
    show player 11
    dia "That's how we met and became friends with your {b}Father{/b}!"
    show diane 12
    show player 5
    dia "... and also where I found my stupid ex-husband. Haha!"
    show diane 13
    player_name "..."
    show diane 10
    show player 11
    dia "I had such bad taste in men..."
    dia "I wish I had found a nice, handsome, young man... Like you."
    show diane 7
    dia "..."
    show diane 22
    dia "What am I saying? You don't want to hear all of this!"
    show diane 24
    show player 21
...
label dianes_dialogue_pre_fun_milk_delivery_delivered:
    show diane 1 at right
    show player 2 at left
    player_name "I've got some great news, {b}Diane{/b}!"
...
label dianes_dialogue_pre_fun_milk_delivery_try_milk:
    ...
    show diane 4 at right
    show player 21 at left
    player_name "Awesome! Thanks, {b}Diane{/b}!"
...
label dianes_dialogue_pre_fun_bug_infestation_not_done:
    ...
    show player 21
    player_name "But don't worry, {b}Diane{/b}! I'll find a way!"
    show player 13
    show diane 3
    dia "Haha."
...
label dianes_dialogue_pre_fun_bug_infestation_done:
    ...
    show diane 1
    show player 12
    player_name "Took me awhile but they are all dead now!"
    show diane 3
    show player 2
    dia "That's amazing!"
    show diane 10
    show player 11
    dia "I'm so lucky to have a {b}handy man{/b} like you around, {b}[firstname]{/b}!"
    show diane 9
    show player 29
    ...
    show diane 14
    show player 11
    dia "Well, if you won't let me pay you back; I'll just have to give you a raise!"
    show diane 4
    player_name "..."
    show diane 10
    show player 13
    dia "Hehe, see? Two can play at this game!"
    show diane 9
    show player 21
...
label dianes_dialogue_pre_fun_leave:
    show diane 1 at right
    show player 17 at left
    player_name "I was just about to started on the garden..."
    dia "Eager to get those muscles working, I see!"
    show player 11
    show diane 10
    dia "Come here, and give old {b}Diane{/b} a nice {b}kiss{/b}!"
    hide player 11
    show diane 11 at left
    player_name "..."
    hide diane 11 at left with dissolve
...
label dianes_dialogue_after_fun_intro:
    ...
    if not game.timer.is_weekend():
        dia "Dropping by my house on the way back from school?"
    else:
        dia "Bored at home, and felt like seeing little old me?"
    show diane 88
    show player 29
    ...
    if not store._in_replay == None:
        call expression game.dialog_select("dianes_dialogue_after_fun_have_fun") from _call_expression_941
    return
...
label dianes_dialogue_after_fun_talk:
    ...
    show diane 92
    show player 5
    dia "It's been a long time since a man has shown me any interest."
    show diane 88
    show player 2
    player_name "That's crazy! You're so sexy, {b}Diane{/b}."
    player_name "I can't believe you're wasting your time with me..."
    show diane 109 at Position (xpos=947)
    show player 108f
    player_name "... You're completely out of my league!"
    show diane 90 at right
    show player 13
    dia "Don't be silly, {b}[firstname]{/b}. You're wonderful!"
    show diane 88
    show player 108f
    player_name "Thanks..."
    show diane 89
    show player 13
    dia "It's exciting, being naughty in secret like this, isn't it?"
    dia "I know it really gets my motor going!"
    show diane 88
    show player 17
    player_name "Yeah... I don't want it to stop..."
    show diane 89
    show player 13
    dia "Well my door is always open for you, {b}[firstname]{/b}."
    show diane 88
    show player 17
    player_name "Thanks..."
    show diane 89
...
label dianes_dialogue_after_fun_talk_about_debbie_intro:
    show diane 109 at Position (xpos=947)
    show player 24
    player_name "I worry about {b}[deb_name]{/b}..."
    show diane 92 at right
    show player 5
    dia "What do you mean?"
    show diane 91
    show player 10
    player_name "She seems really stressed out, with everything that's happened recently..."
    show diane 92
    show player 13
    dia "I've known {b}[deb_name]{/b} since we were kids. She's a strong woman, {b}[firstname]{/b}."
    show diane 87
    dia "She'll be fine!"
    show diane 91
    show player 24
    ...
    show diane 89 at right
    show player 11
    dia "{b}[firstname]{/b}, do you have feelings for {b}[deb_name]{/b}?"
    show diane 88
    show player 29
    player_name "Huh? Feelings?"
    show diane 89
    show player 3
    dia "You know what I mean..."
    dia "Sexual feelings... Do you ever imagine yourself doing things with her? Things like you and I do during our {b}secret fun{/b} sessions?"
    return
...
label dianes_dialogue_after_fun_talk_about_debbie_confess:
    ...
    show player 21
    player_name "I can't help it! She's so beautiful..."
    show diane 109 at Position (xpos=947)
    show player 108f
    player_name "... And we're around each other so often nowadays."
    show diane 110 at Position (xpos=950)
    show player 13
    dia "Heh, well this is an interesting turn of events!"
    show diane 89 at right
    show player 11
    dia "Have you told her?"
    show diane 88
    show player 10
    player_name "No way..."
    show diane 89
    show player 11
    dia "Why not? If she's making you feel this way-"
    show diane 109 at Position (xpos=947)
    show player 29
    player_name "I can't do that! What if she freaks out?!"
    show diane 90 at right
    show player 13
    dia "Oh, good grief! Trust me, {b}[firstname]{/b}. She's not the type to freak out over something like this!"
    show diane 89
    show player 11
    dia "Have you tried giving her {b}hints{/b}?"
    show diane 87
    dia "You never know, she might be into it..."
    show diane 88
    show player 21
    player_name "What do you mean?"
    show diane 89
    show player 13
    dia "I'm sure she's lonely too. She lost her husband ages ago and now that your {b}father{/b} is gone..."
    show diane 87
    dia "She could use a man that's willing to take care of her and satisfy her needs..."
    show diane 88
    show player 108f
...
label dianes_dialogue_after_fun_talk_about_debbie_do_not_confess:
    ...
    dia "I see..."
    show diane 89
    dia "She's lucky to have you staying with her."
    show diane 88
    show player 21
    player_name "Thanks..."
    show diane 89
...
label dianes_dialogue_after_fun_diane_breeding_guide_not_known:
    ...
    dia "It seems that I'm pushing the limits of my breasts. I can only squeeze so much out of these puppies..."
    show diane 91
    show player 10
    ...
    show diane 88
    show player 29
    player_name "Hmm, maybe I can find us some information about milk production."
    show diane 89
    show player 13 at left
    dia "Really?"
    show diane 88
    ...
    show player 13
    show diane 90
    dia "You're such a great kid, {b}[firstname]{/b}!"
    show diane 87
...
label dianes_dialogue_after_fun_do_not_have_milkjug:
    ...
    dia "I'm sure we can find something like that somewhere in the {b}mall{/b}."
    show diane 88
    show player 10
...
label dianes_dialogue_after_fun_have_milkjug:
    ...
    show diane 88
    show player 173
    player_name "I found your {b}milk jug{/b}!"
    show diane 90
    show player 172
    dia "Heh, you mean my {b}thermal tank{/b}?"
    show diane 118
    show player 1
    dia "Thank you so much, {b}[firstname]{/b}."
    dia "You really saved my bacon here!"
    show diane 88
    show player 17
    player_name "It's nothing, {b}Diane!{/b}"
    show player 14
...
label dianes_dialogue_after_fun_have_breeding_guide:
    ...
    show diane 158
    show player 10
    player_name "So what do you think, {b}Diane{/b}?"
    show player 5
    show diane 160
    dia "I... don't..."
    show diane 157
    ...
    dia "My ex never wanted any..."
    show diane 91 at Position(xpos=1024)
    dia "..."
    show diane 92
    dia "But I'm not too old, yet..."
    show diane 89
    dia "I can't believe how turned on I am by that farming manual!"
    show diane 88
    pause
    show diane 92
    dia "Just the idea of {b}being breed like an animal{/b}..."
    dia "... Oh, goodness me.."
    show diane 89
    ...
    dia "Hmm."
    show diane 87
    dia "I wonder how {b}[firstname]{/b} would feel about being my {b}bull{/b}?"
    show diane 92
    dia "..."
    show diane 89
    dia "He does have a big nice cock, just like a {b}bull{/b}..."
    show diane 110 at Position(xpos=950)
    dia "He's still in college though! He's practically a kid! I can't ask him for this... Can I?"
    dia "What would {b}[deb_name]{/b} say if she heard me talking about this?!"
    show diane 91 at Position(xpos=1024)
    dia "..."
    show diane 92
    dia "Oh, she would be so angry..."
    dia "Hehe. Okay, that's getting me even more worked up!"
    show diane 88
    pause
    show diane 92
    dia "He probably won't even be interested..."
    dia "... But I have to do something if I'm going to expand this milk business."
    show diane 89
    dia "Doing nothing isn't really an option."
    show diane 88
    pause
    show diane 87
    dia "I suppose I could talk with him about it."
    show diane 89
    dia "Please, {b}[firstname]{/b}... {b}Breed me{/b} with that huge cock!"
    show diane 88
    dia "Fill me up and make me yours!"
    show diane 89
    dia "Mmm, where did I put that cucumber?"
    show diane 92
    dia "I need to clear my head!"
    hide diane with dissolve
    return

label dianes_dialogue_after_fun_diane_breeding_help_not_known_intro:
    show player 10
    player_name "Any luck finding a {b}healthy young bull{/b} to {b}breed{/b} with?"
    show player 5
    show diane 87
    dia "Oh... You know me..."
    show diane 92
...
label dianes_dialogue_after_fun_diane_breeding_help_not_known_fail:
    ...
    show diane 91
    show player 10
    player_name "[chr_warn]Sure, {b}Diane{/b}."
    show player 5
    show diane 92
...
label dianes_dialogue_after_fun_diane_breeding_help_not_known_pass:
    ...
    dia "Yes... we do, but..."
    show diane 89
    dia "We're talking about bringing a life into the world. That means responsibilities!"
    show diane 88
    show player 21
    player_name "I know. I thought you were ready to accept those responsibilities?"
    show player 5
    show diane 91
    dia "..."
    show player 11
    ...
    dia "I... I am!"
    show diane 92
    dia "... But I can't ask you to do that!"
    show diane 91
    show player 33
    player_name "Who's asking me? I'm offering to {b}breed you, Diane{/b}. I want to."
    show player 1
    pause
    show diane 89
    dia "Oh my... I.. I would like that very much!"
    show diane 88
    show player 11
    player_name "!!!"
    show player 1
    show diane 89
    dia "You really want this, {b}[firstname]{/b}?!"
    show diane 90
    dia "I thought you just liked to fool around, you know?"
    show diane 88
    show player 21
    player_name "No, I... I really like doing those things with you {b}Diane{/b}!"
    ...
    dia "{b}[deb_name]{/b} can never know about this, okay?!"
    show diane 88
    show player 14
    ...
    show diane 88
    show player 21
    player_name "See you there, {b}Diane{/b}!"
    hide player
    hide diane
    with dissolve
    return
...
label dianes_dialogue_after_fun_have_fun_first_time:
    ...
    dia "I've never seen one this big before..."
    show dianesex 2
...
label dianes_dialogue_after_fun_have_fun_first_time_yes:
    ...
    pause
    show playersex 3
    player_name "You're so pretty, {b}Diane{/b}..."
    show dianesex 15
    dia "..."
    show dianesex 14
    dia "You keep talking like that and I'm gonna have to invite you to sleep over."
    show dianesex 13
...
label dianes_dialogue_after_fun_have_fun_first_time_want_fail:
    ...
    player_name "[chr_warn]I... I want to be inside you {b}Diane{/b}."
    dia "[chr_warn]..."
    show dianesex 14
...
label dianes_dialogue_after_fun_have_fun_first_time_want_pass:
    show dianesex 15 at right
    player_name "I... I want to be inside you {b}Diane{/b}."
    dia "!!!"
    show dianesex 17
...
label aunt_sex_cum_in:
    ...
    $ aunt_had_sex = True
    call expression game.dialog_select("aunt_sex_end") from _call_expression_942
...
label aunt_sex_cum_out:
    ...
    dia "...Let's get cleaned up."
    $ aunt_had_sex = True
    call expression game.dialog_select("aunt_sex_end") from _call_expression_943
...
label aunt_sex_end:
    if not aunt_had_sex:
        call expression game.dialog_select("aunt_sex_end_first_time") from _call_expression_944
    else:
        call expression game.dialog_select("aunt_sex_end_first_repeat") from _call_expression_945
    $ renpy.end_replay()
...
label aunt_sex_end_first_time:
    ...
    show player 11
    dia "We'll relieve all that stress you're building up at school."
    show diane 88
    show player 17
...
label dianes_dialogue_after_fun_have_fun_repeat_leave:
    ...
    show diane 87
    show player 11
    dia "Any time. I'm always hungry..."
    show diane 88
    show player 17
    player_name "Oh. Haha..."
    show diane 87
...
label aunt_masturbate:
    if not aunt_masturbating_seen:
        call expression game.dialog_select("aunt_masturbate_not_seen") from _call_expression_946
        $ persistent.cookie_jar["Diane"]["unlocked"] = True
...
label find_shovel:
    ...
    if player.has_item("shovel"):
        ...
        player_name "I should find a {b}shovel{/b} before I can help with the garden..."
    hide player with dissolve
    $ game.main()
