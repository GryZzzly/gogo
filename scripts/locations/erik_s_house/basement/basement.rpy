label erik_basement:
    ...
    if M_dewitt.get_state() == S_dewitt_eve_karaoke and game.timer.is_dark():
        call expression game.dialog_select("eriks_basement_dewitt_eve_karaoke") from _call_expression_1478
        if game.cheat_mode:
            menu:
                "Play Minigame":
        ...
        call expression game.dialog_select("eriks_basement_first_time") from _call_expression_1479
