label erik_indoors:
    ...
    if erik.over(erik_gf) and not erik.known(erik_gf_2):
        call expression game.dialog_select("erikentrance_erik_gf_over") from _call_expression_1228
        ...
        call expression game.dialog_select("erikentrance_erik_sex_ed_block") from _call_expression_1229

    elif mrsj.over(mrsj_poker_night) and not mrsj.known(mrsj_poker_night_2):
        call expression game.dialog_select("erikentrance_mrsj_poker_night_over") from _call_expression_1230
        ...
        call expression game.dialog_select("erikentrance_erik_thief_2_over") from _call_expression_1231
        $ mrsj.add_event(mrsj_poker_night)

    elif erik.over(erik_thief) and not erik.known(erik_thief_2):
        call expression game.dialog_select("erikentrance_erik_thief_over") from _call_expression_1232
        ...
        call expression game.dialog_select("erikentrance_mrsj_yoga_2_over") from _call_expression_1233
        $ erik.add_event(erik_breastfeeding)


    elif mrsj.started(mrsj_yoga_help_2):
        call expression game.dialog_select("erikentrance_mrsj_yoga_2_started") from _call_expression_1234
        ...
        call expression game.dialog_select("erikentrance_erik_vr_over") from _call_expression_1235
        ...
        call expression game.dialog_select("eriks_house_intro") from _call_expression_1236
        if not game.timer.is_dark():
            call expression game.dialog_select("erikentrance_mrsj_intro_started_day") from _call_expression_1237
        else:


            call expression game.dialog_select("erikentrance_mrsj_intro_started_night") from _call_expression_1238
        $ mrsj_intro.finish()
        hide mrsj
        hide player
        with dissolve
        ...
        call expression game.dialog_select("erikentrance_erik_orcette_completed") from _call_expression_1239
