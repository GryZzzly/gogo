...
label mrsj_private_yoga:
    ...
    call expression game.dialog_select("mrsjroom_mrsj_private_yoga_intro") from _call_expression_237
    $ anim_toggle = True
    $ xray = False
    ...
    label mrsj_private_yoga_pos1_repeat:
        ...
        label erimom_private_pos1_switch:
            ...
            call expression game.dialog_select("mrsjroom_mrsj_private_yoga_pos1") from _call_expression_238
            $ anim_toggle = True
            ...
            label mrsj_private_yoga_pos2_repeat:
                ...
                label erimom_private_pos2_cum:
                    call expression game.dialog_select("mrsjroom_mrsj_private_yoga_pos2") from _call_expression_239
                    $ renpy.end_replay()
...
label mrsj_3some:
    ...
    $ player.go_to(L_erikhouse_entrance)
    $ mrsj_filled = True
    call expression game.dialog_select("mrsjroom_mrsj_3some_intro") from _call_expression_240
    $ anim_toggle = True
    $ xray = False
    $ M_mrsj.set('sex speed', .4)
    ...
    label mrsj_3some_pos1_repeat:
        ...
        label mrsj_3some_pos1_switch:
            hide screen mrsj_3some_pos1_sex_options
            $ M_mrsj.set('sex speed', .3)
            call expression game.dialog_select("mrsjroom_mrsj_3some_pos1") from _call_expression_241
            $ anim_toggle = True
            ...
            label mrsj_3some_pos2_repeat:
                ...
                label mrsj_3some_pos2_cum:
                    call expression game.dialog_select("mrsjroom_mrsj_3some_pos2") from _call_expression_242
                    $ renpy.end_replay()
                    $ persistent.cookie_jar["Mrs Johnson"]["unlocked"] = True
