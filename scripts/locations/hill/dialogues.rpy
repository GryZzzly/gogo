...
label hill_tree:
    ...
    if not player.has_item("scroll"):
        call expression game.dialog_select("hill_tree_no_scroll") from _call_expression_245
...
label hill_dewitt_stick:
    call expression game.dialog_select("hill_dewitt_stick_dialogue") from _call_expression_246
...
label hill_harolds_car:
    call expression game.dialog_select("hill_harolds_car_dialogue") from _call_expression_247
