label hill_dialogue:
    ...
    if L_hill.first_visit and not M_mia.is_state(S_mia_find_harold):
        call expression game.dialog_select("hill_first_visit") from _call_expression_243
        $ L_hill.visited()

    elif M_mia.is_state(S_mia_find_harold):
        call expression game.dialog_select("hill_mia_find_harold") from _call_expression_244
    $ game.main()
