...
label egay_search_dialogue:
    if erik.started(erik_orcette):
        call expression game.dialog_select("egay_search_dialogue_erik_orcette_started") from _call_expression_1409
...
label webcam_dialogue:
    ...
    if not connected:
        call expression game.dialog_select("webcam_dialogue_not_connected") from _call_expression_1410
        ...
        if sister.started(sis_webcam01) or sister.started(sis_webcam02) or sister.started(sis_webcam03) or sister.over(sis_webcam04):
            ...
            if sister.started(sis_webcam01):
                label electroclit_replay:
                    call expression game.dialog_select("webcam_dialogue_sis_webcam_started_pre") from _call_expression_1411
                call expression game.dialog_select("webcam_dialogue_sis_webcam01_started_pre") from _call_expression_1412
                $ current_camshow = 1

            elif sister.started(sis_webcam02):
                label ultravibrator_replay:
                    call expression game.dialog_select("webcam_dialogue_sis_webcam_started_pre") from _call_expression_1413
                call expression game.dialog_select("webcam_dialogue_sis_webcam02_started_pre") from _call_expression_1414
                $ current_camshow = 2

            elif sister.started(sis_webcam03):
                label dualsybian_replay:
                    call expression game.dialog_select("webcam_dialogue_sis_webcam_started_pre") from _call_expression_1415
                call expression game.dialog_select("webcam_dialogue_sis_webcam03_started_pre") from _call_expression_1416
                $ current_camshow = 3

            elif sister.over(sis_webcam04):
                $ sis_lastwebcam_show_seen = True
                label badmonster_replay:
                    call expression game.dialog_select("webcam_dialogue_sis_webcam_started_pre") from _call_expression_1417
                call expression game.dialog_select("webcam_dialogue_sis_webcam04_started_pre") from _call_expression_1418
                $ current_camshow = 4
            $ anim_toggle = False
            $ xray_toggle = False
            ...
            call expression game.dialog_select("webcam_dialogue_nothing_showing") from _call_expression_1419
    else:

        call expression game.dialog_select("webcam_dialogue_nothing_showing") from _call_expression_1420
    show screen MC_computer
...
label sis_camshow_finish:
    ...
    if current_camshow == 1:
        call expression game.dialog_select("sis_camshow_01_finish") from _call_expression_1421
        $ sis_webcam01.finish()
        if not sister.known(sis_telescope01):
            $ sister.add_event(sis_telescope01)

    elif current_camshow == 2:
        call expression game.dialog_select("sis_camshow_02_finish") from _call_expression_1422
        ...
        call expression game.dialog_select("sis_camshow_03_finish") from _call_expression_1423
        ...
        call expression game.dialog_select("sis_camshow_04_finish") from _call_expression_1424
