...
label bedroom_study01:
    if M_bissette.is_state(S_bissette_french_food_assignment):
        call expression game.dialog_select("bedroom_bissette_french_food_assignment_after") from _call_expression_1888
        $ M_bissette.trigger(T_bissette_do_assignment)
        $ game.timer.tick()

    elif M_bissette.is_state(S_bissette_do_poem_assignment):
        call expression game.dialog_select("bedroom_bissette_do_poem_assignment") from _call_expression_1889
        $ M_bissette.trigger(T_bissette_do_assignment)
        $ game.timer.tick()
    else:
        ...
        if M_bissette.between_states(S_bissette_find_food_book, [S_bissette_got_dexters_eriks_books, S_bissette_got_eriks_martinez_books, S_bissette_got_martinez_eriks_books]):
            call expression game.dialog_select("bedroom_bissette_find_books") from _call_expression_1890
        else:

            call expression game.dialog_select("bedroom_no_school_work") from _call_expression_1891
    $ game.main()
...
label mia_midnight_text:
    call expression game.dialog_select("mia_midnight_text_dialogue") from _call_expression_1892
...
label mia_urgent_text:
    call expression game.dialog_select("mia_urgent_text_dialogue") from _call_expression_1893
    $ M_mia.trigger(T_mia_message)
    $ game.main()
...
label bedroom_sleeping_debbie_night_visit_three_loop:
    menu:
        ...
        "Cum.":
            ...
            call expression game.dialog_select("bedroom_sleeping_debbie_night_visit_three_cum_pre") from _call_expression_1894
            ...
            call expression game.dialog_select("bedroom_sleeping_debbie_night_visit_three_cum_after") from _call_expression_1895
    $ renpy.end_replay()
...
label bedroom_debbie_sleepover:
    call expression game.dialog_select("bedroom_debbie_sleepover_pre") from _call_expression_1896
    if randomizer() < 33:
        call expression game.dialog_select("bedroom_debbie_sleepover_random_33") from _call_expression_1897

    elif randomizer() < 66:
        call expression game.dialog_select("bedroom_debbie_sleepover_random_66") from _call_expression_1898

    elif randomizer() < 100:
        call expression game.dialog_select("bedroom_debbie_sleepover_random_100") from _call_expression_1899
...
label bedroom_debbie_sleepover_cum:
    call expression game.dialog_select("bedroom_debbie_sleepover_cum_dialogue") from _call_expression_1900
    ...
    if randomizer() < 70 and not M_mom.is_state(S_mom_note):
        call expression game.dialog_select("bedroom_debbie_sleepover_after_random_70") from _call_expression_1901
    else:

        call expression game.dialog_select("bedroom_debbie_sleepover_after_not_random") from _call_expression_1902
        if not M_mom.is_set("basement sex"):
            call expression game.dialog_select("bedroom_debbie_sleepover_after_not_basement_sex") from _call_expression_1903
...
label M6_note:
    call expression game.dialog_select("M6_note_dialogue") from _call_expression_1904
