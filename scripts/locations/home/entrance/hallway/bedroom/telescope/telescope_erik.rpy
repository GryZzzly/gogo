label erik_bedroom:
    if sister.started(sis_telescope01):
        call expression game.dialog_select("telescope_erik_sister_spying") from _call_expression_939
        ...
        call expression game.dialog_select(game.telescope.erik) from _call_expression_940
