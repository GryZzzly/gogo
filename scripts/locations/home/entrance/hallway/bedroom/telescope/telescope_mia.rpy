label mia_bedroom:
    if sister.started(sis_telescope02):
        call expression game.dialog_select("telescope_mia_sister_spying") from _call_expression_977
        ...
        call expression game.dialog_select(game.telescope.mia) from _call_expression_978
...
label telescope_mia_night_2:
    if not M_mia.get("telescope teddy seen"):
        ...
        call telescope_mia_night_3 from _call_telescope_mia_night_3
    return
