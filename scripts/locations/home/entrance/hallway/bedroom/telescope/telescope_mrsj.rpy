label erikmom_bedroom:
    if sister.started(sis_telescope03):
        call expression game.dialog_select("telescope_mrsj_sister_spying") from _call_expression_1257
        ...
        call expression game.dialog_select(game.telescope.mrsj) from _call_expression_1258
