    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            if animcounter in [1,2,3]:
                call expression game.dialog_select("debbie_shower_hscene_dialog") from _call_expression_103
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            if animcounter in [1,2,3]:
                call expression game.dialog_select("debbie_shower_hscene_dialog") from _call_expression_104
        $ animcounter += 1
...
label mom_shower_sex_cum:
    call expression game.dialog_select("mom_shower_sex_cum_pre") from _call_expression_105
    $ cum = True
    call expression game.dialog_select("mom_shower_sex_cum_after") from _call_expression_106
...
label mom_shower_end:
    call expression game.dialog_select("mom_shower_end_dialogue") from _call_expression_107
    $ renpy.end_replay()
    $ game.timer.tick()
    $ playSound()
...
label shower_sis_sex_intro:
    ...
    if sis_shower_intro_first:
        call expression game.dialog_select("shower_sis_sex_intro_first") from _call_expression_108
        $ sis_shower_intro_first = False
    else:

        call expression game.dialog_select("shower_sis_sex_intro_repeat") from _call_expression_109
    ...
    menu:
        "Oops, Sorry!":
            call expression game.dialog_select("shower_sis_sex_intro_sorry") from _call_expression_110
        "Need help?":

            if sis_shower_intro_first:
                call expression game.dialog_select("shower_sis_sex_intro_help_fail") from _call_expression_111
            else:

                label sis_shower_jump_1:
                    call expression game.dialog_select("shower_sis_sex_intro_help_pass") from _call_expression_112
            $ M_jenny.set("seen MCs penis", True)
            call expression game.dialog_select("sis_shower_sex") from _call_expression_113
    hide jenny
    hide player
    with dissolve
    $ playSound()
...
label sis_shower_sex:
    call expression game.dialog_select("sis_shower_sex_pre") from _call_expression_114
    if not store._in_replay == None:
        call expression game.dialog_select("sis_shower_jump_2") from _call_expression_115
    menu:
        "Leave.":
            call expression game.dialog_select("sis_shower_sex_leave") from _call_expression_116

        "Beg." if not sister.known(sis_shower_cuddle03):
            call expression game.dialog_select("sis_shower_sex_first_beg_fail") from _call_expression_117
        ...
        "Beg." if sister.known(sis_shower_cuddle03):
            ...
            label sis_shower_jump_2:
                call expression game.dialog_select("sis_shower_sex_first_beg_pass") from _call_expression_118
            if not store._in_replay == None:
                call expression game.dialog_select("sis_shower_jump_3") from _call_expression_119
            menu:
                "Leave.":
                    call expression game.dialog_select("sis_shower_sex_leave") from _call_expression_120

                "Beg." if not sister.known(sis_shower_cuddle04):
                    call expression game.dialog_select("sis_shower_sex_second_beg_fail") from _call_expression_121
                ...
                "Beg." if sister.known(sis_shower_cuddle04):
                    ...
                    label sis_shower_jump_3:
                        call expression game.dialog_select("sis_shower_sex_second_beg_pass") from _call_expression_122
                    if not store._in_replay == None:
                        call expression game.dialog_select("sis_shower_jump_4") from _call_expression_123
                    menu:
                        "Put it inside." if not sister.known(sis_shower_cuddle05) or player.stats.dex() < 7:
                            call expression game.dialog_select("sis_shower_sex_put_it_in_fail") from _call_expression_124
                        ...
                        "Put it inside." if sister.known(sis_shower_cuddle05) and player.stats.dex() >= 7:
                            ...
                            label sis_shower_jump_4:
                                ...
                                $ anim_toggle = False
                                $ xray = False
                            call expression game.dialog_select("sis_shower_sex_put_it_in_pass") from _call_expression_125
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            if animcounter in [1,3]:
                call expression game.dialog_select("jenny_shower_hscene_dialog") from _call_expression_126
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            if animcounter in [1,3]:
                call expression game.dialog_select("jenny_shower_hscene_dialog") from _call_expression_127
        $ animcounter += 1
...
label sis_shower_sex_cum_1:
    if anim_toggle:
        call expression game.dialog_select("sis_shower_sex_cum_1_pre_animation") from _call_expression_128
    else:
        call expression game.dialog_select("sis_shower_sex_cum_1_pre_manual") from _call_expression_129
    $ xray = False
    call expression game.dialog_select("sis_shower_sex_cum_1_after") from _call_expression_130
    $ playSound()
    jump expression game.dialog_select("hallway_dialogue")
...
label sis_shower_sex_cum_2:
    if anim_toggle:
        call expression game.dialog_select("sis_shower_sex_cum_2_animation") from _call_expression_131
    else:
        call expression game.dialog_select("sis_shower_sex_cum_2_manual") from _call_expression_132
    call expression game.dialog_select("sis_shower_sex_cum_2_pre") from _call_expression_133
    $ xray = False
    call expression game.dialog_select("sis_shower_sex_cum_2_after") from _call_expression_134
    $ playSound()
    $ renpy.end_replay()
