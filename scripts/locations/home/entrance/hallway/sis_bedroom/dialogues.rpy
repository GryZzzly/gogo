...
label sis_bedroom_sis_mom_needs_you:
    call expression game.dialog_select("sis_bedroom_sis_mom_needs_you_pre") from _call_expression_248
    menu:
        "She needs help.":
            call expression game.dialog_select("sis_bedroom_sis_mom_needs_you_help") from _call_expression_249
    return
...
label sneak_in_sis_bed:
    ...
    call expression game.dialog_select("sneak_in_sis_bed_pre") from _call_expression_250
    ...
    menu:
        "Leave.":
            call expression game.dialog_select("sneak_in_sis_bed_pre_leave") from _call_expression_251
        ...
        "Cuddle." if sister.known(sis_shower_cuddle01) and not sister.known(sis_shower_cuddle02):
            ...
            label sis_bed_replay_fail:
                call expression game.dialog_select("sneak_in_sis_bed_cuddle_fail") from _call_expression_252
            $ renpy.end_replay()
        ...
        "Cuddle." if sister.known(sis_shower_cuddle02):
            ...
            label sis_bed_replay_cont:
                call expression game.dialog_select("sneak_in_sis_bed_cuddle_pass") from _call_expression_253
    ...
    menu:
        "Leave.":
            call expression game.dialog_select("sneak_in_sis_bed_cuddle_leave") from _call_expression_254
            jump expression game.dialog_select("hallway_dialogue")

        "Squeeze boobs." if not sister.known(sis_shower_cuddle03):
            label sis_bed_replay_fail_2:
                call expression game.dialog_select("sneak_in_sis_bed_squeeze_boobs_fail") from _call_expression_255
            $ renpy.end_replay()
            $ persistent.cookie_jar["Jenny"]["unlocked"] = True
            $ persistent.cookie_jar["Jenny"]["gallery"]["07_unlocked"] = True
        ...
        "Squeeze boobs." if sister.known(sis_shower_cuddle03):
            ...
            label sis_bed_replay_cont_2:
                call expression game.dialog_select("sneak_in_sis_bed_squeeze_boobs_pass") from _call_expression_256
    ...
    menu:
        "Leave.":
            call expression game.dialog_select("sneak_in_sis_bed_squeeze_boobs_leave") from _call_expression_257
            jump expression game.dialog_select("hallway_dialogue")

        "Rub pussy." if not sister.known(sis_shower_cuddle04):
            label sis_bed_replay_fail_3:
                call expression game.dialog_select("sneak_in_sis_bed_rub_pussy_fail") from _call_expression_258
            $ renpy.end_replay()
            $ persistent.cookie_jar["Jenny"]["unlocked"] = True
            $ persistent.cookie_jar["Jenny"]["gallery"]["07_unlocked"] = True
        ...
        "Rub pussy." if sister.known(sis_shower_cuddle04):
            ...
            label sis_bed_replay_cont_3:
                call expression game.dialog_select("sneak_in_sis_bed_rub_pussy_pass") from _call_expression_259
    ...
    menu:
        "Leave.":
            call expression game.dialog_select("sneak_in_sis_bed_rub_pussy_leave") from _call_expression_260
            jump expression game.dialog_select("hallway_dialogue")
        ...
        "Put it inside." if not sister.known(sis_shower_cuddle05) or player.stats.dex() < 7:
            label sis_bed_replay_fail_4:
                ...
                if not store._in_replay == None:
                    $ stat_warn = dex_warn
                call expression game.dialog_select("sneak_in_sis_bed_sex_stat_fail") from _call_expression_261
            $ renpy.end_replay()
            $ persistent.cookie_jar["Jenny"]["unlocked"] = True
            $ persistent.cookie_jar["Jenny"]["gallery"]["07_unlocked"] = True
        ...
        "Put it inside." if sister.known(sis_shower_cuddle05) and player.stats.dex() >= 7:
            ...
            label sis_bed_replay_cont_4:
                call expression game.dialog_select("sneak_in_sis_bed_sex_stat_pass") from _call_expression_262
    ...
    menu:
        "Rabbit fuck.":
            label sis_bed_replay_fuck:
                call expression game.dialog_select("sneak_in_sis_bed_rabbit_fuck") from _call_expression_263

    menu sisbedroom_sex_loop:
        "Keep going.":
            call expression game.dialog_select("sneak_in_sis_bed_rabbit_fuck_keep_going") from _call_expression_264
        ...
        "Cum inside." if store._in_replay == "sis_bed_replay_5" or store._in_replay == None and player.stats.str() < 7:
            call expression game.dialog_select("sneak_in_sis_bed_rabbit_fuck_cum_inside_stat_fail") from _call_expression_265
            $ renpy.end_replay()
            $ persistent.cookie_jar["Jenny"]["unlocked"] = True
            $ persistent.cookie_jar["Jenny"]["gallery"]["07_unlocked"] = True
        ...
        "Cum inside." if store._in_replay == "sis_bed_replay_final" or store._in_replay == None and player.stats.str() >= 7:
            call expression game.dialog_select("sneak_in_sis_bed_rabbit_fuck_cum_inside_stat_pass") from _call_expression_266
            $ renpy.end_replay()
            $ persistent.cookie_jar["Jenny"]["unlocked"] = True
            $ persistent.cookie_jar["Jenny"]["gallery"]["07_unlocked"] = True
        ...
        "Cum outside.":
            ...
            call expression game.dialog_select("sneak_in_sis_bed_rabbit_fuck_cum_outside") from _call_expression_267
            $ renpy.end_replay()
            $ persistent.cookie_jar["Jenny"]["unlocked"] = True
            $ persistent.cookie_jar["Jenny"]["gallery"]["07_unlocked"] = True
...
label diary_dialogue:
    ...
    $ counter = 1
    while counter <= 4:
        call expression game.dialog_select("diary0" + str(counter)) from _call_expression_268
        $ counter += 1
    call expression game.dialog_select("diary_after") from _call_expression_269
    $ game.main()
...
label bedtable_night:
    call expression game.dialog_select("bedtable_night_dialogue") from _call_expression_270
    $ in_sis_room = True
...
label bedside01_dialogue:
    call expression game.dialog_select("bedside01_dialogue{}".format(random.randint(1,2))) from _call_expression_271
...
label siscomp_day:
    call expression game.dialog_select("siscomp_day_pre") from _call_expression_272
    if L_home_shower.is_here(M_jenny):
        call expression game.dialog_select("siscomp_day_showering") from _call_expression_273
    else:
        call expression game.dialog_select("siscomp_day_not_showering") from _call_expression_274
...
label jennys_bedroom_bissette_roxxy_jenny_spying:
    ...
    if M_roxxy.get("roxxy trailer sex"):
        $ suffix = "_sex"
    call expression game.dialog_select("jennys_bedroom_bissette_roxxy_jenny_spying_pre{}".format(suffix)) from _call_expression_275
    if M_jenny.is_set("seen MCs penis"):
        call expression game.dialog_select("jennys_bedroom_bissette_roxxy_jenny_spying_seen_penis{}".format(suffix)) from _call_expression_276
    else:
        call expression game.dialog_select("jennys_bedroom_bissette_roxxy_jenny_spying_havent_seen_penis{}".format(suffix)) from _call_expression_277
    call expression game.dialog_select("jennys_bedroom_bissette_roxxy_jenny_spying_after") from _call_expression_278
    $ del suffix
    $ renpy.end_replay()
    return
