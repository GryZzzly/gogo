...
label sispc_nude_response:
    if sispc_nude_seen == False:
        call expression game.dialog_select("sispc_nude_response_dialogue") from _call_expression_136
...
label sispc_family_response:
    if sispc_family_seen == False:
        call expression game.dialog_select("sispc_family_response_dialogue") from _call_expression_137
...
label sispc_swimsuit_response:
    if sispc_swimsuit_seen == False:
        call expression game.dialog_select("sispc_swimsuit_response_dialogue") from _call_expression_138
...
label sispc_igor_response:
    if sispc_igor_seen == False:
        call expression game.dialog_select("sispc_igor_response_dialogue") from _call_expression_139
...
label sispc_summertime_response:
    if sispc_summertime_seen == False:
        call expression game.dialog_select("sispc_summertime_response_dialogue") from _call_expression_140
...
label sispc_webcam_response:
    if sispc_webcam_seen == False:
        call expression game.dialog_select("sispc_webcam_response_dialogue") from _call_expression_141
...
label sispc_toylist_response:
    if sispc_toylist_seen == False:
        call expression game.dialog_select("sispc_toylist_response_dialogue") from _call_expression_142
...
label sispc_livecrush_response:
    if sispc_livecrush_seen == False:
        call expression game.dialog_select("sispc_livecrush_response_dialogue") from _call_expression_143
...
label sispc_email_response:
    if sispc_email_seen == False:
        call expression game.dialog_select("sispc_email_response_dialogue") from _call_expression_144
...
label sispc_email04_response:
    if sis_email_04_read == False:
        call expression game.dialog_select("sispc_email04_response_dialogue") from _call_expression_145
