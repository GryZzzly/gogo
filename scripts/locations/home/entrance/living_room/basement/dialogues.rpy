...
label basement_mom_sex:
    ...
    call expression game.dialog_select("basement_mom_sex_pre") from _call_expression_361
...
label basement_mom_sex_loop:
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            pause 4
            call expression game.dialog_select("debbie_basement_hscene_dialog") from _call_expression_362
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            call expression game.dialog_select("debbie_basement_hscene_dialog") from _call_expression_363
        $ animcounter += 1
...
label basement_mom_sex_after:
    if M_mom.is_state(S_mom_give_laundry):
        call expression game.dialog_select("basement_mom_sex_after_pre_give_laundry") from _call_expression_364

    elif mom_basement_rand:
        call expression game.dialog_select("basement_mom_sex_after_pre_random") from _call_expression_365
    else:

        call expression game.dialog_select("basement_mom_sex_after_pre") from _call_expression_366
    $ renpy.end_replay()
...
label basement_confession_kiss:
    call expression game.dialog_select("basement_confession_kiss_pre") from _call_expression_367
    if randomizer() <= M_mom.get("mom concerned"):
        ...
        call expression game.dialog_select("basement_confession_kiss_concerned_random") from _call_expression_368
    call expression game.dialog_select("basement_confession_kiss_after") from _call_expression_369
...
label broken_pipe:
    call expression game.dialog_select("broken_pipe_dialogue") from _call_expression_370
...
label laundry_dialogue:
    call expression game.dialog_select("laundry_dialogue_pre") from _call_expression_371
    menu:
        "Let me help.":
            call expression game.dialog_select("laundry_dialogue_help") from _call_expression_372
            $ M_mom.trigger(T_mom_cleaned_laundry)
        "You're busy.":


            call expression game.dialog_select("laundry_dialogue_busy") from _call_expression_373
    ...
    if M_mom.is_set("lotion fun"):
        if player.location == L_home_basement:
            ...
            if M_mom.is_set("sex available"):
                call expression game.dialog_select("mom_lotion_fun_kitchen_sex_available") from _call_expression_374
        ...
        call expression game.dialog_select("mom_lotion_fun_pre") from _call_expression_375
        call expression game.dialog_select("mom_lotion_fun_location_dialogue") from _call_expression_376
        call expression game.dialog_select("mom_lotion_fun_location_dialogue_after") from _call_expression_377
        ...
        call expression game.dialog_select("mom_lotion_fun_after") from _call_expression_378
    else:

        call expression game.dialog_select("mom_lotion_fun_first_pre") from _call_expression_379
        menu:
            "Help her.":
                call expression game.dialog_select("mom_lotion_fun_first_help_her") from _call_expression_380
                $ player.go_to(L_home_livingroom)
                $ M_mom.set("lotion fun", True)
            "Leave.":

                call expression game.dialog_select("mom_lotion_fun_first_leave") from _call_expression_381
