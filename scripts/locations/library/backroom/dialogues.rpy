...
label backroom_couple_finish:
    call expression game.dialog_select("backroom_couple_finish_dialogue") from _call_expression_1407
    $ renpy.end_replay()
...
label poem_assignment_book:
    call expression game.dialog_select("poem_assignment_book_dialogue") from _call_expression_1408
