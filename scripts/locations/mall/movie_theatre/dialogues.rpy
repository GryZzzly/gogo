...
label movie_theatre_movie_select_after:
    call expression game.dialog_select("movie_theatre_movie_select_after_dialogue") from _call_expression_2179
    call expression game.dialog_select("movie_theatre_watch_movie") from _call_expression_2180
    $ player.go_to(L_mall)
    $ game.main()
