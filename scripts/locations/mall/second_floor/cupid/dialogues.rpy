...
label necklace_display:
    ...
    if M_mom.is_state(S_mom_choose_gift):
        call expression game.dialog_select("necklace_display_mom_choose_gift") from _call_expression_2200
        $ M_mom.trigger(T_mom_pick_necklace)
    else:

        call expression game.dialog_select("necklace_display_repeat") from _call_expression_2201
    $ game.main()
...
label cupid_dressroom:
    ...
    if M_mom.is_state(S_mom_dressing_room):
        call expression game.dialog_select("cupid_dressroom_mom_dressing_room") from _call_expression_2202
...
label mom_cupid_outing_block:
    scene location_mall_cupid_blur
    if M_mom.is_state(S_mom_choose_gift):
        call expression game.dialog_select("mom_cupid_outing_block_choose_gift") from _call_expression_2203

    elif M_mom.is_state(S_mom_show_necklace):
        call expression game.dialog_select("mom_cupid_outing_block_show_necklace") from _call_expression_2204

    elif M_mom.is_state(S_mom_dressing_room):
        call expression game.dialog_select("mom_cupid_outing_block_dressing_room") from _call_expression_2205
    $ game.main()
