...
label ivy_paizuri:
    call expression game.dialog_select("ivy_paizuri_pre") from _call_expression_621
    if M_ivy.get("first visit"):
        call expression game.dialog_select("ivy_paizuri_first") from _call_expression_622
        $ M_ivy.set("first visit", False)
    else:

        call expression game.dialog_select("ivy_paizuri_repeat") from _call_expression_623
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
        call expression game.dialog_select("ivy_paizuri_hscene_dialog") from _call_expression_624
        $ animcounter += 1
        if animcounter < 3:
...
label ivy_blowjob:
    call expression game.dialog_select("ivy_blowjob_pre") from _call_expression_625
    if M_ivy.get("first visit"):
        call expression game.dialog_select("ivy_blowjob_first") from _call_expression_626
        $ M_ivy.set("first visit", False)
    else:

        call expression game.dialog_select("ivy_blowjob_repeat") from _call_expression_627
    $ M_ivy.set("sex speed", 0.8)
    $ animcounter = 0
    $ anim_toggle = False
    $ xray_needed = False
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            while poses_done != pose_list:
                ...
                $ poses_done.append(pose_list[pose_counter])
                $ pose_counter += 1
        call expression game.dialog_select("ivy_blowjob_hscene_dialog") from _call_expression_628
        $ animcounter += 1
        if animcounter < 3:
...
label ivy_reverse_cowgirl:
    call expression game.dialog_select("ivy_reverse_cowgirl_pre") from _call_expression_629
    if M_ivy.get("first visit"):
        call expression game.dialog_select("ivy_reverse_cowgirl_first") from _call_expression_630
        $ M_ivy.set("first visit", False)
    call expression game.dialog_select("ivy_reverse_cowgirl_after") from _call_expression_631
    $ M_ivy.set("sex speed", 0.8)
    $ animcounter = 0
    $ anim_toggle = False
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            while poses_done != pose_list:
                ...
                $ poses_done.append(pose_list[pose_counter])
                $ pose_counter += 1
        call expression game.dialog_select("ivy_reverse_cowgirl_hscene_dialog") from _call_expression_632
        $ animcounter += 1
        if animcounter < 3:
...
label ivy_cowgirl:
    call expression game.dialog_select("ivy_cowgirl_pre") from _call_expression_633
    if M_ivy.get("first visit"):
        call expression game.dialog_select("ivy_cowgirl_first") from _call_expression_634
        $ M_ivy.set("first visit", False)
    call expression game.dialog_select("ivy_cowgirl_after") from _call_expression_635
    $ M_ivy.set("sex speed", 0.8)
    $ animcounter = 0
    $ anim_toggle = False
    $ ivy_cum_inside = False
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            while poses_done != pose_list:
                ...
                $ poses_done.append(pose_list[pose_counter])
                $ pose_counter += 1
        call expression game.dialog_select("ivy_cowgirl_hscene_dialog") from _call_expression_636
        $ animcounter += 1
        if animcounter < 3:
