...
label rump_toilets_stall:
    call expression game.dialog_select("rump_toilets_stall_dialogue") from _call_expression_1682
    $ renpy.end_replay()
...
label rump_toilets_stall_block:
    call expression game.dialog_select("rump_toilets_stall_block_dialogue") from _call_expression_1683
    $ game.timer.tick()
