...
label mia_mailbox:
    if game.mail["mia"] == "m_pizza_pamphlet":
        call expression game.dialog_select("mia_mailbox_pizza_pamphlet") from _call_expression_987
        $ L_pizzeria_exterior.unlock()
        $ L_dealership_front.unlock()
    elif game.mail["mia"] == "m_newspaper":
        call expression game.dialog_select("mia_mailbox_newspaper") from _call_expression_988
