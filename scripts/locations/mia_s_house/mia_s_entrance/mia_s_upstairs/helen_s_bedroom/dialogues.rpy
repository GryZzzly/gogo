...
label helen_bedroom_sex:
    call expression game.dialog_select("helen_bedroom_sex_intro") from _call_expression_186
    if not store._in_replay == None:
        call expression game.dialog_select("helen_bedroom_sex_yes") from _call_expression_187
        jump expression game.dialog_select("helen_bedroom_sex_start")
    menu:
        "Another time.":
            call expression game.dialog_select("helen_bedroom_sex_leave") from _call_expression_188
        "I want to.":

            call expression game.dialog_select("helen_bedroom_sex_yes") from _call_expression_189
            ...
            call expression game.dialog_select("helen_bedroom_sex_start_after") from _call_expression_190
            $ anim_toggle = True
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            if animcounter in [1,3]:
                call expression game.dialog_select("helen_hscene_dialog") from _call_expression_191
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            if animcounter in [1,3]:
                call expression game.dialog_select("helen_hscene_dialog") from _call_expression_192
        $ animcounter += 1
...
label helen_bedroom_sex_cum:
    call expression game.dialog_select("helen_bedroom_sex_cum_intro") from _call_expression_193
    if not M_helen.is_state(S_helen_master_servant_fun):
        $ game.timer.tick()
        call expression game.dialog_select("helen_bedroom_sex_cum_repeat") from _call_expression_194
    else:
    ...
    call expression game.dialog_select("helen_bedroom_sex_cum_after") from _call_expression_195
