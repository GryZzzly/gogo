...
label mia_study:
    $ game.timer.tick()
    call expression game.dialog_select("mia_study_intro") from _call_expression_1033
    menu:
        mia "Do you... Also like me?"
        "Yes.":
            call expression game.dialog_select("mia_study_like_mia") from _call_expression_1034
            menu:
                "Close your eyes.":
                    call expression game.dialog_select("mia_study_like_mia_kiss") from _call_expression_1035
                    $ M_player.set("jerk mia", True)
                    $ M_mia.trigger(T_mia_kiss)
        "No.":

            call expression game.dialog_select("mia_study_dislike_mia") from _call_expression_1036
...
label mia_strip_show:
    call expression game.dialog_select("mia_strip_show_dialogue") from _call_expression_1037
    $ game.timer.tick()
...
label mia_bedroom_sex:
    call expression game.dialog_select("mia_bedroom_sex_intro") from _call_expression_1038
    if not store._in_replay == None:
        call expression game.dialog_select("mia_bedroom_sex_study") from _call_expression_1039
        call expression game.dialog_select("mia_bedroom_sex_sure") from _call_expression_1040
        jump expression game.dialog_select("mia_strip_repeat")
    menu:
        "Study":
            call expression game.dialog_select("mia_bedroom_sex_study") from _call_expression_1041
            menu:
                "Maybe later.":
                    call expression game.dialog_select("mia_bedroom_sex_maybe_later") from _call_expression_1042
                "Sure!":

                    call expression game.dialog_select("mia_bedroom_sex_sure") from _call_expression_1043
                    label mia_strip_repeat:
                        call expression game.dialog_select("mia_bedroom_sex_strip_repeat") from _call_expression_1044

                    if M_mia.get("cum 1st choice") == "":
                        call expression game.dialog_select("mia_bedroom_sex_first_intro") from _call_expression_1045
                    else:

                        call expression game.dialog_select("mia_bedroom_sex_repeat_intro") from _call_expression_1046
                    menu:
                        "Butt is fine.":
                            $ M_mia.set("anal sex", True)
                            call expression game.dialog_select("mia_bedroom_sex_butt_intro") from _call_expression_1047

                            label mia_butt_start:
                                call expression game.dialog_select("mia_bedroom_sex_butt_start") from _call_expression_1048
                        ...
                        "I like the other way." if store._in_replay == None and player.stats.chr() < 7:
                            $ M_mia.set("anal sex", True)
                            call expression game.dialog_select("mia_bedroom_sex_vaginal_stat_fail") from _call_expression_1049
                        ...
                        "Just the tip!" if not store._in_replay == None or player.stats.chr() >= 7:
                            ...
                            if not M_mia.is_set("vaginal sex"):
                                ...
                                call expression game.dialog_select("mia_bedroom_sex_vaginal_first_intro") from _call_expression_1050
                            else:

                                call expression game.dialog_select("mia_bedroom_sex_vaginal_repeat_intro") from _call_expression_1051

                            call expression game.dialog_select("mia_bedroom_sex_vaginal_intro") from _call_expression_1052
...
label mia_bedroom_sex_loop:
    ...
    while animcounter < 4:
        if anim_toggle:
            ...
            pause 6
            if animcounter in [2]:
                call expression game.dialog_select("mia_hscene_dialog") from _call_expression_1053
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            if animcounter in [2]:
                call expression game.dialog_select("mia_hscene_dialog") from _call_expression_1054
        $ animcounter += 1
...
label mia_bedroom_sex_cum_outside:
    call expression game.dialog_select("mia_bedroom_sex_cum_outside_intro") from _call_expression_1055
    if M_mia.get("cum 1st choice") == "":
        $ M_mia.set("cum 1st choice", "Outside")
        call expression game.dialog_select("mia_bedroom_sex_cum_outside_first") from _call_expression_1056
    else:

        call expression game.dialog_select("mia_bedroom_sex_cum_outside_repeat") from _call_expression_1057
        if M_mia.is_set("cum 1st choice") == "Inside":
            call expression game.dialog_select("mia_bedroom_sex_cum_outside_first_inside") from _call_expression_1058

    call expression game.dialog_select("mia_bedroom_sex_cum_outside_after") from _call_expression_1059
...
label mia_bedroom_sex_cum_inside:
    ...
    if M_mia.is_set("anal sex"):
        call expression game.dialog_select("mia_bedroom_sex_cum_inside_anal_intro") from _call_expression_1060
        if M_mia.get("sex 1st choice") == "":
            $ M_mia.set("sex 1st choice", "Anal")
            call expression game.dialog_select("mia_bedroom_sex_cum_inside_anal_first") from _call_expression_1061
        call expression game.dialog_select("mia_bedroom_sex_cum_inside_anal_after") from _call_expression_1062
    else:

        call expression game.dialog_select("mia_bedroom_sex_cum_inside_vaginal_intro") from _call_expression_1063
        if M_mia.get("sex 1st choice") == "":
            $ M_mia.set("sex 1st choice", "Vaginal")
            call expression game.dialog_select("mia_bedroom_sex_cum_inside_vaginal_first") from _call_expression_1064
        else:

            call expression game.dialog_select("mia_bedroom_sex_cum_inside_vaginal_repeat") from _call_expression_1065
    jump expression game.dialog_select("mia_bedroom_sex_end")
...
label mia_bedroom_sex_end:
    ...
    call expression game.dialog_select("mia_bedroom_sex_end_dialogue") from _call_expression_1066
...
label mia_bedroom_teddy:
    if M_mia.is_set("telescope teddy seen"):
        call expression game.dialog_select("mia_bedroom_teddy_masturbation_seen") from _call_expression_1067
    else:

        call expression game.dialog_select("mia_bedroom_teddy_masturbation_havent_seen") from _call_expression_1068
    $ game.main()
