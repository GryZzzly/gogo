label park_bushes_dialogue:
    ...
    if M_mia.is_state(S_mia_stolen_goods) and not erik.started(erik_father_treasure):
        call expression game.dialog_select("park_bushes_mia_stolen_goods") from _call_expression_741

    elif erik.started(erik_father_treasure):
        call expression game.dialog_select("park_bushes_erik_father_treasure_started") from _call_expression_742
    $ game.main()
...
label park_bushes_bag_dialogue:
    ...
    if M_mia.is_state(S_mia_stolen_goods) and not erik.started(erik_father_treasure):
        call expression game.dialog_select("park_bushes_bag_mia_stolen_goods") from _call_expression_743

    elif erik.started(erik_father_treasure):
        call expression game.dialog_select("park_bushes_bag_erik_father_treasure_started") from _call_expression_744
