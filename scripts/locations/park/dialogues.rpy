...
label park_rap_battle:
    ...
    if M_dewitt.is_state(S_dewitt_eve_meet_up):
        call expression game.dialog_select("park_dewitt_eve_meet_up") from _call_expression_1161
        $ M_dewitt.trigger(T_dewitt_gang_deal)

    elif M_eve.is_set("first park visit"):
        call expression game.dialog_select("park_rap_battle_first_visit") from _call_expression_1162
        $ M_eve.set("first park visit", False)
        menu:
            "You look good!":
                call expression game.dialog_select("park_rap_battle_first_visit_look_good") from _call_expression_1163
                jump expression game.dialog_select("park_rap_battle_options")
            "I should go home.":

                call expression game.dialog_select("park_rap_battle_first_visit_go_home") from _call_expression_1164
    else:

        call expression game.dialog_select("park_rap_battle_pre") from _call_expression_1165
        menu park_rap_battle_options:
            "Let's rap battle.":
                call expression game.dialog_select("park_rap_battle_start") from _call_expression_1166
                menu:
                    "Chico":
                        $ rap_opponent = "Chico"
                        call expression game.dialog_select("park_rap_battle_opponent") from _call_expression_1167
                    ...
                    "Chad" if player.stats.chr() >= 4:
                        $ rap_opponent = "Chad"
                        call expression game.dialog_select("park_rap_battle_opponent") from _call_expression_1168
                        jump expression game.dialog_select("rapbattle_listing")
                    ...
                    "Tyrone" if player.stats.chr() >= 7:
                        $ rap_opponent = "Tyrone"
                        call expression game.dialog_select("park_rap_battle_opponent") from _call_expression_1169
                        jump expression game.dialog_select("rapbattle_listing")
            ...
            "I have to go.":
                ...
                call expression game.dialog_select("park_rap_battle_leave") from _call_expression_1170
...
label park_rap_battle_opponent:
    if rap_opponent == "Chico":
        ...
        call expression game.dialog_select("park_rap_battle_opponent_chico") from _call_expression_1171
    else:

        player_name "I'll go against {b}[rap_opponent]{/b}."
        hide eve with dissolve
        if rap_opponent == "Chad":
            call expression game.dialog_select("park_rap_battle_opponent_chad") from _call_expression_1172
        else:

            call expression game.dialog_select("park_rap_battle_opponent_tyrone") from _call_expression_1173
...
label park_rap_battle_opponent_chico:
    if chico_battle_count == 0:
        call expression game.dialog_select("park_rap_battle_opponent_chico_first") from _call_expression_1174
        $ chico_battle_count = 1
    else:

        call expression game.dialog_select("park_rap_battle_opponent_chico_repeat") from _call_expression_1175
    return
...
label park_take_picture_judith:
    call expression game.dialog_select("park_take_picture_judith_pre") from _call_expression_1176
    if player.has_picked_up_item("masterkey"):
        call expression game.dialog_select("park_take_picture_judith_have_master_key") from _call_expression_1177
    else:

        call expression game.dialog_select("park_take_picture_judith_do_not_have_master_key") from _call_expression_1178
...
label coin_dialogue:
    call expression game.dialog_select("coin_dialogue_pre") from _call_expression_1179
    $ player.get_item("weird_coin")
    call expression game.dialog_select("coin_dialogue_after") from _call_expression_1180
    $ player.location.call_screen(False, False)
...
label park_pilly_button:
    call expression game.dialog_select("park_pilly_button_dialogue") from _call_expression_1181
    $ player.go_to(L_map)
