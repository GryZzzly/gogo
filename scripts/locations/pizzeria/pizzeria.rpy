label pizza_exterior_dialogue:
    ...
    if L_pizzeria_exterior.first_visit:
        call expression game.dialog_select("pizza_exterior_first_visit") from _call_expression_2206
...
label pizza_interior_dialogue:
    ...
    if M_tony.is_state(S_tony_start):
        call expression game.dialog_select("pizza_interior_pizza_count_0") from _call_expression_2207
