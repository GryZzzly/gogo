...
label pool_cutscene01:
    ...
    call expression game.dialog_select("pool_cutscene01_dialogue") from _call_expression_1322
    $ changing_count = 0
    return
...
label gloryhole_medic:
    call expression game.dialog_select("gloryhole_medic_dialogue") from _call_expression_1323
    $ game.timer.tick()
