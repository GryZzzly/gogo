label gym_dialogue:
    ...
    if M_roxxy.is_state(S_roxxy_intense_gymercise):
        call expression game.dialog_select("courtyard_roxxy_intense_gymercise") from _call_expression_1856
        $ M_roxxy.trigger(T_roxxy_in_shower)

    elif M_bridget.is_state(S_bridget_intro):
        call expression game.dialog_select("courtyard_bridget_intro") from _call_expression_1857
        $ shower_door_count = 1
        ...
        call expression game.dialog_select("courtyard_bridget_training") from _call_expression_1858
    $ game.main()
