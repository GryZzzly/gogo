...
label eve_locker_drawing_pick_up:
    ...
    call expression game.dialog_select("eve_locker_drawing_picked_up") from _call_expression_1476
...
label take_broken_flute:
    ...
    call expression game.dialog_select("take_broken_flute_dialogue") from _call_expression_1477
