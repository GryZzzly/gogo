...
label airvent_webcam_quest:
    call expression game.dialog_select("airvent_webcam_quest_intro") from _call_expression_2076
    $ player.remove_item("supersaga_webcam")
    $ M_erik.set("webcam help", True)
    menu:
        "Can't tell you.":
            call expression game.dialog_select("airvent_webcam_quest_do_not_tell") from _call_expression_2077
        "Hidden webcam.":

            call expression game.dialog_select("airvent_webcam_quest_tell") from _call_expression_2078

    $ game.timer.tick()
    call expression game.dialog_select("map_dialogue") from _call_expression_2079
...
label latinas_shower_dialogue:
    ...
    if M_bissette.is_state(S_bissette_jane_return_books):
        call expression game.dialog_select("bissette_book_search_2_books_left") from _call_expression_2080
    elif M_bissette.is_state([S_bissette_got_dexters_book, S_bissette_got_eriks_book, S_bissette_got_martinez_book]):
        call expression game.dialog_select("bissette_book_search_1_book_left") from _call_expression_2081
    else:
        call expression game.dialog_select("bissette_book_search_no_books_left") from _call_expression_2082
