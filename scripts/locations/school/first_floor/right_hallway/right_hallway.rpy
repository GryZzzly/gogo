label right_hall_dialogue:
    ...
    call pa_announcement from _call_pa_announcement_11
    ...
    if M_roxxy.is_state(S_roxxy_go_in_auditorium):
        call expression game.dialog_select("school_righthallway_roxxy_go_in_auditorium") from _call_expression_1529
