...
label smith_painting:
    if not player.has_item("smith_painting_key") and game.timer.is_dark():
        call expression game.dialog_select("smith_painting_dialogue") from _call_expression_1131
...
label smith_exams:
    call expression game.dialog_select("smith_exams_dialogue") from _call_expression_1132
...
label smith_window_exit_dialogue:
    if M_roxxy.is_state(S_roxxy_sneak_into_smith) and player.has_item("smith_exams"):
        call expression game.dialog_select("smith_window_exit_roxxy_sneak_into_smith") from _call_expression_1133
