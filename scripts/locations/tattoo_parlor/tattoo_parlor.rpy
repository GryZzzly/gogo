...
label tattoo_parlor_interior_dialogue:
    ...
    if L_tattooparlor_interior.first_visit:
        ...
        call expression game.dialog_select("tattooparlor_first_visit") from _call_expression_975

    if M_mia.is_state(S_mia_get_tattoo) and player.location.is_here(M_mia):
        call expression game.dialog_select("tattooparlor_mia_get_tattoo") from _call_expression_976
