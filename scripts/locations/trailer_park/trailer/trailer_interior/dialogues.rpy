...
label trailer_interior_crystal_sex_offer_menu:
    menu:
        "Okay...":
            call expression game.dialog_select("trailer_interior_crystal_sex_offer_accept") from _call_expression_1379
            call expression game.dialog_select("trailer_interior_crystal_sex_or_anal_menu") from _call_expression_1380
            $ anim_toggle = True
        ...
        "I can't do this..." if not M_crystal.is_set("crystal sex offer denied"):
            call expression game.dialog_select("trailer_interior_crystal_sex_offer_denied_first") from _call_expression_1381
            $ M_crystal.set("crystal sex offer denied", True)

        "I still can't do this..." if M_crystal.is_set("crystal sex offer denied"):
            call expression game.dialog_select("trailer_interior_crystal_sex_offer_denied_repeat") from _call_expression_1382
    $ game.main()
    ...
    menu:
        "Sex.":
            ...
            if M_roxxy.get("roxxy crystal sex") and not L_trailer.is_here(M_crystal):
                call expression game.dialog_select("trailer_interior_crystal_sex_or_anal_choose_sex_first") from _call_expression_1383

            elif L_trailer.is_here(M_crystal):
                call expression game.dialog_select("trailer_interior_crystal_sex_or_anal_choose_sex_outside") from _call_expression_1384
            else:

                call expression game.dialog_select("trailer_interior_crystal_sex_or_anal_choose_sex_repeat") from _call_expression_1385
        "Anal.":

            $ M_crystal.set("crystal anal", True)
            if M_roxxy.get("roxxy crystal sex") and not L_trailer.is_here(M_crystal):
                call expression game.dialog_select("trailer_interior_crystal_sex_or_anal_choose_anal_first") from _call_expression_1386

            elif L_trailer.is_here(M_crystal):
                call expression game.dialog_select("trailer_interior_crystal_sex_or_anal_choose_anal_outside") from _call_expression_1387
            else:

                call expression game.dialog_select("trailer_interior_crystal_sex_or_anal_choose_anal_repeat") from _call_expression_1388
    return
...
label trailer_interior_crystal_sex_loop:
    ...
    while animcounter < 4:
        if anim_toggle:
            show expression AnimatedImage("crystals", [1,2,3,4,5,6,7,8], M_crystal) as crystals
            pause 5
            call expression game.dialog_select("crystal_trailer_interior_hscene_dialog") from _call_expression_1389
            pause 3
        else:
            ...
            while poses_done != pose_list:
                ...
                $ pose_counter += 1
            call expression game.dialog_select("crystal_trailer_interior_hscene_dialog") from _call_expression_1390
        $ animcounter += 1
...
label trailer_interior_crystal_sex_cum:
    if L_trailer.is_here(M_crystal):
        if M_crystal.is_set("crystal anal"):
            call expression game.dialog_select("trailer_interior_crystal_sex_outside_cum_anal") from _call_expression_1391
        else:

            call expression game.dialog_select("trailer_interior_crystal_sex_outside_cum") from _call_expression_1392

    elif M_roxxy.get("roxxy crystal sex"):
        if M_crystal.is_set("crystal anal"):
            call expression game.dialog_select("trailer_interior_crystal_sex_cum_repeat_anal") from _call_expression_1393
        else:

            call expression game.dialog_select("trailer_interior_crystal_sex_cum_repeat") from _call_expression_1394

    elif M_crystal.is_set("crystal anal"):
        call expression game.dialog_select("trailer_interior_crystal_sex_cum_first_anal") from _call_expression_1395
        $ M_roxxy.set("roxxy crystal sex", 0)
    else:

        call expression game.dialog_select("trailer_interior_crystal_sex_cum_first") from _call_expression_1396
        $ M_roxxy.set("roxxy crystal sex", 0)
    $ renpy.end_replay()
...
label trailer_interior_crystal_sex_repeat_outside_offer_menu:
    menu:
        "O-okay.":
            call expression game.dialog_select("trailer_interior_crystal_sex_repeat_outside_offer_accept") from _call_expression_1397
            call expression game.dialog_select("trailer_interior_crystal_sex_or_anal_menu") from _call_expression_1398
            $ anim_toggle = True
            jump expression game.dialog_select("trailer_interior_crystal_sex_loop")
        "No way!":

            call expression game.dialog_select("trailer_interior_crystal_sex_repeat_outside_offer_denied") from _call_expression_1399
    $ game.main()
