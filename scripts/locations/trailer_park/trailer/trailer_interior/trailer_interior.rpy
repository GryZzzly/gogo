label trailer_interior_dialogue:
    ...
    if M_roxxy.is_state(S_roxxy_get_cheerleader_outfit):
        call expression game.dialog_select("trailer_interior_roxxy_get_cheerleader_outfit") from _call_expression_21
        ...
        call expression game.dialog_select("trailer_interior_crystal_sex_offer_pre_first") from _call_expression_22
        ...
        call expression game.dialog_select("trailer_park_first_visit") from _call_expression_23
    $ game.main()
