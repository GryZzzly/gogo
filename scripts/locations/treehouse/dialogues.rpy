...
label treehouse_got_wood_pile:
    ...
    if M_ross.is_state(S_ross_get_easels):
        call expression game.dialog_select("treehouse_woodpile_ross_easels") from _call_expression_354

    elif M_dewitt.between_states(S_dewitt_garage_find_paint, S_dewitt_make_replacement_guitar):
        call expression game.dialog_select("treehouse_woodpile_dewitt_guitar") from _call_expression_355

    call expression game.dialog_select("treehouse_woodpile_after") from _call_expression_356
...
label treehouse_got_controller:
    call expression game.dialog_select("treehouse_controller_dialogue_pre") from _call_expression_357
    $ player.get_item("controller")
    call expression game.dialog_select("treehouse_controller_dialogue_after") from _call_expression_358
    $ game.main()
...
label lure_02:
    call expression game.dialog_select("lure_02_dialogue_pre") from _call_expression_359
    $ player.get_item("lure01")
    call expression game.dialog_select("lure_02_dialogue_after") from _call_expression_360
    $ game.main()
