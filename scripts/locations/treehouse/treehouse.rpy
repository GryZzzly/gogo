label treehouse_dialogue:
    ...
    if L_treehouse.first_visit:
        call expression game.dialog_select("treehouse_first_visit") from _call_expression_469
        $ L_treehouse.visited()
    $ game.main()
...
label treehouse_closeup_dialogue:
    ...
    if L_treehouse_closeup.first_visit:
        call expression game.dialog_select("treehouse_closeup_first_visit") from _call_expression_470
...
label treehouse_interior_dialogue:
    ...
    if L_treehouse_interior.first_visit:
        call expression game.dialog_select("treehouse_interior_first_visit") from _call_expression_471
