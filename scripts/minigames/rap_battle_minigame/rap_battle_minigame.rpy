...
label rapbattle_win:
    ...
    scene park_bench
    if rap_opponent == "Chico":
        call expression game.dialog_select("rapbattle_win_chico") from _call_expression_1249

    elif rap_opponent == "Chad":
        call expression game.dialog_select("rapbattle_win_chad") from _call_expression_1250

    elif rap_opponent == "Tyrone":
        $ A_eminem.unlock()
        call expression game.dialog_select("rapbattle_win_tyrone") from _call_expression_1251
    ...
    if M_eve.is_set("first rap battle"):
        call expression game.dialog_select("rapbattle_win_after_eve") from _call_expression_1252
...
label rapbattle_lose:
    ...
    scene park_bench
    if rap_opponent == "Chico":
        call expression game.dialog_select("rapbattle_win_chico") from _call_expression_1253

    elif rap_opponent == "Chad":
        call expression game.dialog_select("rapbattle_win_chad") from _call_expression_1254

    elif rap_opponent == "Tyrone":
        call expression game.dialog_select("rapbattle_win_tyrone") from _call_expression_1255
    ...
    if M_eve.is_set("first rap battle"):
        call expression game.dialog_select("rapbattle_lose_after_eve") from _call_expression_1256
        $ M_eve.set("first rap battle", False)
    $ game.main()
