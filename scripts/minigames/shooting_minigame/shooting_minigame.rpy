...
label shooting_range_fail:
    ...
    if M_roxxy.is_state(S_roxxy_beat_clyde):
        if M_roxxy.get("lost shooting"):
            call expression game.dialog_select("shooting_range_fail_repeat") from _call_expression_1838
        else:
            call expression game.dialog_select("shooting_range_fail_first") from _call_expression_1839
            $ M_roxxy.set("lost shooting", True)
...
label shooting_range_success:
    ...
    if M_roxxy.is_state(S_roxxy_beat_clyde):
        if M_roxxy.get("lost shooting"):
            call expression game.dialog_select("shooting_range_success_failed") from _call_expression_1840
        else:
            call expression game.dialog_select("shooting_range_success_first") from _call_expression_1841
        call expression game.dialog_select("shooting_range_success_outro") from _call_expression_1842
        $ game.timer.tick()
